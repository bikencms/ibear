...
<head>
    ...
    <noscript><link rel="stylesheet" href="{{ url('assets/css/bootstrap.css') }}"></noscript>

    <link rel="stylesheet" href="{{ url('assets/css/style.css') }}">
    <link rel="stylesheet" href="vendors/bootstrap-datepicker/bootstrap-datepicker.min.css">

    <link rel="preload" href="{{ url('vendors/simple-line-icons/css/simple-line-icons.css') }}" as="style" onload="this.onload=null;this.rel='stylesheet'">
...
<main id="shop">
    <header>
        <nav>
            <ul>
                <li class="logo">
                    <a href="#"><img src="{{ url('assets/images/logo_black.webp') }}" alt="Logo"></a>
                </li>
                <li class="link shop">
...
<section class="product-wrapper background-brown">
    ...
    <div class="search">
        <div class="search-inner contact">
            ...
            <p>
                ...
                <a rel="nofollow noreferrer" href="https://www.youtube.com/@ibearvn" class="icon" target="_blank" title="Youtube">
                ...
                <a rel="nofollow noreferrer" href="https://zalo.me/0934369941" class="icon" target="_blank" title="Zalo">
